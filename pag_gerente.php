...
$dni = $_SESSION['dnigerente']; // o el campo que tengas como clave
...
<html lang="es">
    ...
    <body>
        ...
        <section>
            ...
            <div class="container">
                <h3 class="text-center">Bienvenido Gerente <?php echo $_SESSION['nombregerente']." ".$_SESSION['apellidogerente'] ?> !!</h3>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <p>Bienvenido Gerente, espero entiendas esta bella pagina.!</p>
                                </div>
                            </div>
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    <h5>Crear piezas!</h5>
                                    <p>Podes crecarlas, editarlas y eliminarlas.</p>
                                </div>
                            </div>
                            <div class="carousel-item">
